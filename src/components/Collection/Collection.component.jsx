...
function CollectionComponent() {
    ...
    const genderOptions = ["Men", "Women", "Unisex", "Kids", "Elderly", "Teenagers"];
    ...
    return (
        <div className="flex flex-col lg:flex-row relative">
            {/* Sidebar for filters */}
            <div className={`bg-slate-100 lg:block ${isopen ? 'block' : 'hidden'} lg:w-1/4`}>
                <div className="p-3">
                    <div className="pl-9">
                    ...
                    <div className="p-4">
                        ...
                        <FilterBoxComponent header="Product Categories" options={categoryOptions} />
                        <FilterBoxComponent header="Frame Color" options={frameColorOptions} />
                        <FilterBoxComponent header="Filter by Brands" options={brandOptions} />
                        <FilterBoxComponent header="Product Status" options={productStatusOptions} />
                    </div>
                </div>
            </div>
            ...
            <div className="w-full lg:w-3/4 bg-slate-200">
                ...
                <div>
                    <button className="w-full p-5 bg-slate-300 font-semibold">Load More</button>
                    <div className="text-center p-14">
                        “النظارات الواقية الصناعية ضرورية لحماية العمال في البيئات التي تشكل فيها الغبار والحطام والمواد الكيميائية والمخاطر العالية التأثير تهديدًا. تلبي مجموعتنا من النظارات الواقية المعتمدة أعلى المعايير العالمية، بما في ذلك ANSI Z87.1 و EN166، لضمان حماية كاملة للعينين. تتوفر النظارات بعدسات مع أو بدون قوة تصحيحية، ونقدم أنماطًا تناسب كل احتياج صناعي، بدءًا من البناء إلى التصنيع。”
            ...
            {selectedfilter === null ? <div className="flex lg:hidden fixed z-30 bottom-[75px] bg-slate-300 p-3 w-full justify-between">
                <button className="flex flex-col items-center w-[50%] border-r-2" onClick={() => SetSelectedFilter("sort")}>
                ...
                <button className="flex flex-col items-center w-[50%] " onClick={() => SetSelectedFilter("filter")}>
                    <div className="flex items-center gap-3">
            ...
            </div> : <div className="block lg:hidden fixed z-30 bottom-[75px] bg-slate-300 p-3 w-full">
                {selectedfilter === "sort" && <SortComponent SetSelectedFilter={SetSelectedFilter} />}
                {selectedfilter === "filter" && <FilterComponent SetSelectedFilter={SetSelectedFilter} SetFilterCount={SetAppliedFilter} />}
