...
export const SortHelper = (value) => {
  return (
    sortDataOptions.find((obj) => obj.value === value) || sortDataOptions[0]
  );
};
...
export const PriceRangeName = {
  BELOW_2000: "Below 500",
  FROM_2000_TO_3000: "500 - 1000",
  FROM_3000_TO_6000: "1000 - 2000",
  FROM_6000_TO_10000: "2000 - 3000",
  FROM_10000_TO_15000: "3000 - 6000",
};

export const PriceRangeList = Object.values(PriceRangeName);

export const PriceDataRangeMap = {
  [PriceRangeName.BELOW_2000]: { min: 0, max: 500 },
  [PriceRangeName.FROM_2000_TO_3000]: { min: 500, max: 1000 },
  [PriceRangeName.FROM_3000_TO_6000]: { min: 1000, max: 2000 },
  [PriceRangeName.FROM_6000_TO_10000]: { min: 2000, max: 3000 },
  [PriceRangeName.FROM_10000_TO_15000]: { min: 3000, max: 6000 },
};
...
export const PriceDataHelper = ({ min, max }) => {
  ...
  return {
    key: PriceRangeName.BELOW_2000,
    range: PriceDataRangeMap[PriceRangeName.BELOW_2000],
    default: true,
  };
};
